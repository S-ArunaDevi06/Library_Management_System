...
JOptionPane.showMessageDialog(this,ex.getMessage());
 ...
 public void Branch_Load()
 {
       try {
           ...
           while(rs.next())
           {
               ...
               for(int i=1;i<=b;i++)
               {
                   ...
                   v2.add(rs.getString("branch_address"));
                   v2.add(rs.getString("branch_stock"));
    ...
    private void initComponents() {
        ...
        txtbranchadrs = new javax.swing.JTextField();
        txtbranchstock = new javax.swing.JTextField();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Branch_id", "Branch_name", "Branch_address", "Branch_stock"
            }
        ));
        ...
        jLabel4.setText("Branch_adrs");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel5.setText("Branch_stock");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtbranchstock, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(51, 51, 51)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtbranchadrs)
                            .addComponent(txtbranchname)
                            .addComponent(txtbranchid, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(50, 50, 50)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txtbranchadrs, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtbranchstock, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try {
           ...
           ps.setString(1, txtbranchid.getText());
           ps.setString(2, txtbranchname.getText());
           ps.setString(3, txtbranchadrs.getText());
           ps.setString(4, txtbranchstock.getText());
           
           int k=ps.executeUpdate();
           if(k==1)
           {
               JOptionPane.showMessageDialog(this,"Branch Details Inserted");
    ...
    for (int i = 0; i < d.getColumnCount(); i++) {
        System.out.println("Column " + i + ": " + d.getValueAt(selectIndex, i));
    }
    
    txtbranchid.setText(d.getValueAt(selectIndex, 1).toString());
    txtbranchname.setText(d.getValueAt(selectIndex, 2).toString());
    txtbranchadrs.setText(d.getValueAt(selectIndex, 3).toString());
    txtbranchstock.setText(d.getValueAt(selectIndex, 4).toString());
...
txtbranchid.setText(d.getValueAt(selectIndex, 0).toString());  // Assuming branch ID is in the first column
txtbranchname.setText(d.getValueAt(selectIndex, 1).toString()); // Assuming branch name is in the second column
txtbranchadrs.setText(d.getValueAt(selectIndex, 2).toString()); // Assuming branch address is in the third column
txtbranchstock.setText(d.getValueAt(selectIndex, 3).toString()); // Assuming branch stock is in the fourth column
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int selectIndex=jTable1.getSelectedRow();
           ...
           String sql = "update branch set branch_name=?,branch_address=?,branch_stock=? where branch_id=?";
           ps = con.prepareStatement(sql);
           ps.setString(1, txtbranchid.getText());
           ps.setString(2, txtbranchname.getText());
           ps.setString(3, txtbranchadrs.getText());
           ...
           if(k==1)
           {
               JOptionPane.showMessageDialog(this,"Branch Details Updated");
               txtbranchid.requestFocus();
               Branch_Load();
...
try {
    ...
    String branchaddress = txtbranchadrs.getText();
    String branchstock = txtbranchstock.getText();

    String sql = "update branch set branch_name=?, branch_address=?, branch_stock=? where branch_id=?";
    ps = con.prepareStatement(sql);
    ps.setString(1, branchname); 
    ps.setString(2, branchaddress); 
    ps.setString(3, branchstock); 
...
try {
    ...
    if (k == 1) {
        ...
        txtbranchstock.setText("");
        txtbranchadrs.setText("");
        txtbranchid.requestFocus();
        Branch_Load();
    } else {
    ...
    private javax.swing.JTextField txtbranchadrs;
    private javax.swing.JTextField txtbranchid;
    private javax.swing.JTextField txtbranchname;
    private javax.swing.JTextField txtbranchstock;
